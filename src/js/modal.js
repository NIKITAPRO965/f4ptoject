// Перевіряємо, чи цей скрипт уже завантажувався раніше в пам'ять браузера
if (!window.isModalScriptAlreadyLoaded) {
  window.isModalScriptAlreadyLoaded = true; // Ставимо мітку, що скрипт виконано
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gridContainer) {
      gridContainer.addEventListener("click", (e) => {
        ...
        // Додатковий захист: якщо модалка вже фізично є на екрані — нічого не робимо
